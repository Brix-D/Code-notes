...
SECRET_KEY = '7npgruwaro^ag8ryue#w#zx&l-pp6ze^0n)m&8e^rq#_@=ye#u'
...
# Параметр для редиректа при попытке доступа к странице требующей авторизации
